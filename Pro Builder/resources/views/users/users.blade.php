	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Deleting this user account will result in all associated data being deleted (with the exception of externally published funnels) and <b>can not be undone</b>. Are you sure you want to continue?</p>
			</div><!-- /.modal-body -->
