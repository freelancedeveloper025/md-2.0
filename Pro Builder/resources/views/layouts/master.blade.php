...
<head>
	...
	<link href="{{ asset('src/css/vendor/bootstrap.min.css') }}" rel="stylesheet">
	<link href="{{ asset('src/css/flat-ui-pro.css') }}" rel="stylesheet">
	...
	<link href="{{ asset('src/css/builder.css') }}" rel="stylesheet">
	<link href="{{ asset('src/css/spectrum.css') }}" rel="stylesheet">
	<link href="{{ asset('src/css/chosen.css') }}" rel="stylesheet">
	<link href="{{ asset('src/css/summernote.css') }}" rel="stylesheet">
