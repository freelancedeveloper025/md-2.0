...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-4 text-right">
            <a href="{{ route('site-create') }}" class="btn btn-lg btn-primary btn-embossed btn-wide margin-top-40"><span class="fui-plus"></span> Create New Funnel</a>
        </div><!-- /.col -->
    </div><!-- /.row -->
    ...
    <div class="row">
                ...
                <div class="site" data-name="{{ $site['siteData']['user']['first_name'] }} {{ $site['siteData']['user']['last_name'] }}" data-pages="{{ $site['nrOfPages'] }}" data-created="{{ date('Y-m-d', strtotime($site['siteData']['created_at'])) }}" data-update="{{ date('Y-m-d', strtotime($site['siteData']['updated_at'])) }}" id="site_{{ $site['siteData']['id'] }}">
                    ...
                    <div class="siteDetails">
                        ...
                        <p class="siteLink">
                            ...
                            @else
                            Funnel was published on {{ date('Y-m-d', strtotime($site['siteData']['publish_date'])) }}
                            @endif
                            @else
                            <span class="pull-left text-danger">
                                <b>Funnel has not been published</b>
                            </span> &nbsp;&nbsp;
                        ...
                        <div class="clearfix">
                            <a href="{{ route('site', ['site_id' => $site['siteData']['id']]) }}" class="btn btn-primary btn-embossed btn-block"><span class="fui-new"></span> Edit This Funnel</a>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="alert alert-info" style="margin-top: 30px">
                ...
                <p>
                    It appears you might be new around these parts. At the moment, you don't have any funnels to call your own just yet, so why not get started making money by building your first funnel?
                </p>
                <br><br>
                <a href="{{ route('site-create') }}" class="btn btn-primary btn-lg btn-wide">Yes, I want to build a funnel!</a>
