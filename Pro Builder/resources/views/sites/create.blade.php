...
<div id="builder">
    ...
    <div class="container">
        <header class="clearfix" data-spy="affix" data-offset-top="60" data-offset-bottom="200">
            ...
            <div class="btn-group" style="float: right;">
                ...
                <ul class="dropdown-menu dropdown-menu-inverse dropdown-menu-right">
                    <li><a href="#siteSettings" id="siteSettingsButton" class="siteSettingsModalButton" data-siteid="{{ $data['siteData']['site'][0]['id'] }}"><span class="fui-arrow-right"></span> Funnel Settings</a></li>
            ...
            <a href="#exportModal" id="exportPage" data-toggle="modal" class="btn btn-info btn-embossed pull-right actionButtons" style="margin-right: 1px; display: none;"><span class="fui-export"></span> Backup</a>
            ...
            <div class="modes" id="siteBuilderModes">
                <b>Mode:</b>
                <label class="radio primary first" id="modeElementsLabel" data-toggle="tooltip" data-placement="bottom" title="Allows you to add, remove and re-order elements on the canvas. You can also view and edit the block's source HTML">
        ...
        <div class="screen" id="screen">
            <div class="toolbar">
                ...
                <div class="title">
                    <span id="pageTitle">New Funnel</span>
                </div>
            </div>
            <div id="frameWrapper" class="frameWrapper empty">
                ...
                <div class="start" id="start" <?php if( isset($data['siteData']['pages']) && count($data['siteData']['pages']) > 0 ):?>style="display:none"<?php endif;?>>
                    <span>Build your funnel by dragging elements onto the canvas</span>
                </div>
            </div>
        </div><!-- /.screen -->
    ...
    <div id="styleEditor" class="styleEditor">
        ...
        <h3><span class="fui-new"></span> Style Editor</h3>
        <ul class="breadcrumb">
            <li>editing:</li>
            ...
            <div class="tab-pane link_Tab" id="link_Tab">
                ...
                <div class="form-group">
                    <select id="pageLinksDropdown" class="form-control select select-primary btn-block mbl">
                        <option value="#">Choose an element (one page sites)</option>
                    </select>
                </div>
                <p class="text-center or">
                    <span>OR</span>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" type="button" class="btn btn-primary btn-embossed" id="exportSubmit">Backup Now</button>
                    </div>
                </div><!-- /.modal-content -->
            </div><!-- /.modal-dialog -->
        </form>
        ...
        <form action="{{ route('site.publish') }}" target="_blank" id="publishForm" method="post" class="form-horizontal">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <h4 class="modal-title" id="myModalLabel"><span class="fui-upload"></span> Publish your funnel</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="alert alert-info" style="display: none;" id="publishPendingChangesMessage">
                            ...
                            <p>It appears the latest changes to this funnel have not been saved yet. Before you can publish this funnel, you will need to save the last changes.</p>
    ...
    <div class="modal fade small-modal" id="resetBlock" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <p>
                        Are you sure you want to reset this element?
                    </p>
                    <p>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal">Cancel &amp; Close</button>
                    <button type="button" type="button" class="btn btn-primary btn-embossed" id="resetBlockConfirm">Reset Element</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
    ...
    <div class="modal fade small-modal" id="deleteElement" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default btn-embossed" data-dismiss="modal" id="deletePageCancel">Cancel &amp; Close</button>
                    <button type="button" type="button" class="btn btn-primary btn-embossed" id="deleteElementConfirm">Delete Element</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
