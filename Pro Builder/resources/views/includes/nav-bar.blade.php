<nav class="mainnav navbar navbar-inverse navbar-embossed navbar-fixed-top" role="navigation" id="mainNav">
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="">
			<b class='text-primary'>MD</b>Pro Builder
		</a>
	</div>
	<div class="collapse navbar-collapse" id="navbar-collapse-01">
		<ul class="nav navbar-nav">
			...
			<li class="active">
				<a><span class="fui-home"></span> <span id="siteTitle">My New Funnel</span> </a>
			</li>
			@endif
			<li><a href="/dashboard" id="backButton"><span class="fui-arrow-left"></span> Back to Funnels</a></li>
			@else
			<li class="{{ Request::path() ==  'dashboard' ? 'active' : ''  }}"><a href="{{ route('dashboard') }}"><span class="fui-windows"></span> Funnels</a></li>
