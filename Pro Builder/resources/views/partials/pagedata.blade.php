<form class="form-horizontal" role="form" id="pageSettingsForm" action="{{ route('updatePageData') }}">
	...
	<div class="optionPane">
		<div class="form-group">
			<label for="name" class="col-sm-3 control-label">SEO Title:</label>
			<div class="col-sm-9">
				<input type="text" class="form-control" id="pageData_title" name="pageData_title" placeholder="Page title" value="{{ $data['index']['title'] }}">
			</div>
		</div>
		<div class="form-group">
			<label for="name" class="col-sm-3 control-label">SEO Meta Keywords:</label>
			<div class="col-sm-9">
		...
		<div class="form-group">
			<label for="name" class="col-sm-3 control-label">SEO Meta Description:</label>
			<div class="col-sm-9">
